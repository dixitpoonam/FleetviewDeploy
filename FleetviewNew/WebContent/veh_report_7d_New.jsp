...
%>
       <table border="0" cellpadding="0" width="100%" align="center" class="stats">
			...
			<tr>
		<td align="center"><font size="3"><b>Over Speed</b></font></td>   <!--  TABLE 1 -->
	</tr>
	<tr>
		<td>
...
%>
	...
	<tr>
		...
		Acceleration</b></font></td>                      <!--  TABLE 2 -->
	</tr>
	<tr>
		<td>
		<table width="100%" border="1" align="center" class="sortable">
...
<%
 ...
 %>
	...
	<tr>
		<td align="center"><font size="3"><b>Rapid
		Deceleration</b></font></td>                              <!--  TABLE 3 -->
	</tr>
	<tr>
		<td>
		<table width="100%" border="1" align="center" class="sortable">
...
%>
	...
	<tr>
		<td align="center"><font size="3"><b>Stops</b></font></td>    <!--  TABLE 4 -->
	</tr>
	<tr>
		<td>
		<table width="100%" border="1" align="center" class="sortable">
...
<%
	...
	<tr>
		<td align="center"><font size="3"><b>Night Driving</b></font></td>  <!--  TABLE 5 -->
	</tr>
	<tr>
		<td>
		<table width="100%" border="1" align="center" class="sortable">
