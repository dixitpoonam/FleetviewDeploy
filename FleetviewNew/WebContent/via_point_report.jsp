		...
		<div class="content-header row">
			<div class="content-header-left col-md-7 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0"> Via Point Report Of 
							<%=username %></h3>
					</div>
				</div>
			</div>
						    	  				...
						    	  				%>
															<tr>
																<td align="left"><a href="#"
																	title="Delete The Via Point"
																	onclick="return delete1('<%=rs3.getString("TripId") %>','<%=rs3.getString("Vehcode")%>','<%=rs3.getString("ViaLocName")%>')"
																	style="color: #505050"><img src="Delete.png"
																		alt="Delete Record" width="18" height="18" border="0"></a><br></br>
																</td>
																<td align="right"><%=i %></td>
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Via Point Report </h4>
